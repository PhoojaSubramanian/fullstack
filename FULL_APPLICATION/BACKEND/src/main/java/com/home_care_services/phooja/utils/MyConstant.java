...
public class MyConstant {
    ...
    public static final String USER_ALL_DETAILS_GET= "/usergetparticular";
    ...
    //SWAGGER
    public static final String SWAGGER_INFO_TITLE ="HOME CARE SERVICES FOR ELDERS";
    ...
    public static final String SWAGGER_INFO_CONTACT_NAME ="Phooja";
    public static final String SWAGGER_INFO_CONTACT_EMAIL ="727721eucs099@skcet.ac.in";
