...
// import com.home_care_services.phooja.dto.response.UserDetailsDTOResponse;
...
public class UserController {
    ...
    //  @GetMapping(MyConstant.USER_ALL_DETAILS_GET)
    // public ResponseEntity<UserDetailsDTOResponse> getAllUsersDetails() {
    //     try {
    //         List<UserDetailsDTO> userDetailsDTOList = userService.getAllUsersDetails();
    //         UserDetailsDTOResponse userDetailsResponse = new UserDetailsDTOResponse(userDetailsDTOList);
